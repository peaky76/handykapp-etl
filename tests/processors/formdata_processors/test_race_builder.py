...
def test_get_valid_combinations_when_distances_informative(mocker):
    r1a = mocker.Mock(name="r1a", position="1", beaten_distance=0)
    r1b = mocker.Mock(name="r1b", position="1", beaten_distance=0)
    r2a = mocker.Mock(name="r2a", position="2", beaten_distance=0.3)
    r2b = mocker.Mock(name="r2b", position="2", beaten_distance=2)
    r3a = mocker.Mock(name="r3a", position="3", beaten_distance=0.8)
    r3b = mocker.Mock(name="r3b", position="3", beaten_distance=3)
    r4a = mocker.Mock(name="r4a", position="4", beaten_distance=1.5)
    r4b = mocker.Mock(name="r4b", position="4", beaten_distance=4)
