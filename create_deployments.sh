...
poetry run prefect deployment build ./src/extractors/theracingapi_extractor.py:theracingapi_racecards_extractor -n $name -sb $storage -ib $infra -q default -o ./deployments/theracingapi-deployment.yaml --cron "0 17 * * *"
